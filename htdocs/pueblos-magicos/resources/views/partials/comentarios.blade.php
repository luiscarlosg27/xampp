<div class="team-4 section-image" style="background-image: url('https://www.mexicodesconocido.com.mx/wp-content/uploads/2018/11/pueblos_magicos_estado_de_mexico-3.jpg')">
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="card card-profile">
                <div class="card-header card-avatar">
                  <a href="#pablo">
                    <img class="img" src="{{URL:: asset('/img/faces/card-profile1-square.jpg')}}">
                  </a>
                </div>
                <div class="card-body">
